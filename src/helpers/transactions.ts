...
export const ERC721_BADGE_MINTED_TYPE = "ERC721Badge Minted";
export const ERC721_BADGE_BATCH_MINTED_TYPE = "ERC721Badge Batch Minted";
...
export const ERC721_MINTED_TYPE = "ERC721 Minted";
export const ERC721_BATCH_MINTED_TYPE = "ERC721 Batch Minted";
export const ERC721_TRANSFER_TYPE = "ERC721 Transfer";
export const ERC721_BURN_TYPE = "ERC721 Burn";

export const ERC20_CREATE_TYPE = "ERC20 Create";
...
export const TOKEN_MINT_TYPE = "Reward XP";
export const TOKEN_TRANSFER_TYPE = "Transfer Token";

export const BADGE_CREATE_TYPE = "Badge Create";
export const BADGE_MINT_TYPE = "Reward Badge";
